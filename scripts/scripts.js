(function() {
    ...
    var u, c, i, n, y, t, l, v, r, s, a, e, p, w, b, h, f, d, g, m, k, S, q, x, L, P, T, R, j, O, E, M, A, C, N, _, F, U, W, X, D, H, I, z, G, B = [].slice,
        J = {}.hasOwnProperty,
        K = function(t, e) {
    ...
    for (f = {
            ...
            var n, r;
            if (null == t && (t = "options"), null == e && (e = !0), r = document.querySelector("[data-preloader-" + t + "]")) {
                if (n = r.getAttribute("data-preloader-" + t), !e) return n;
                try {
                    return JSON.parse(n)
                } catch (t) {
                    return "undefined" != typeof console && null !== console ? console.error("Error parsing inline preloader options", t) : void 0
                }
            }
        ...
        }, G = V, y = window.preloader || {}, window.preloader = y, d(y, G.prototype), P = y.options = d({}, f, window.preloaderOptions, m()), W = 0, D = (I = ["ajax", "document", "eventLag", "elements"]).length; W < D; W++) !0 === P[A = I[W]] && (P[A] = f[A]);
    ...
    function tt() {
        ...
        if (null != _ && P.ajax.trackWebSockets) {
            window.WebSocket = function(t, e) {
                ...
                return M("socket") && o.trigger("request", {
                    type: "socket",
                    url: t,
                    protocols: e,
                    request: n
    ...
    G = Error, K(Y, G), n = Y, Z.prototype.getElement = function() {
        ...
        if (null == this.el) {
            ...
            this.el = document.createElement("div"), this.el.className = "preloader preloader-active", document.body.className = document.body.className.replace(/(preloader-done)|/, "preloader-running");
            var e = "" !== P.className ? " " + P.className : "";
            this.el.innerHTML = '<div class="preloader-progress' + e + '">\n  <div class="preloader-progress-inner"></div>\n</div>\n<div class="preloader-activity"></div>', null != t.firstChild ? t.insertBefore(this.el, t.firstChild) : t.appendChild(this.el)
        }
        return this.el
    }, Z.prototype.finish = function() {
        var t = this.getElement();
        return t.className = t.className.replace("preloader-active", "preloader-inactive"), document.body.className = document.body.className.replace("preloader-running", "preloader-done")
        ...
        return y.running = !0, w.render(), m = L(), b = !1, e = j(function(t, e) {
            ...
            for (var n, r, s, o, i, a, u, c, l, p, h = a = 0, f = !0, d = u = 0, g = C.length; u < g; d = ++u)
                for (A = C[d], i = null != O[d] ? O[d] : O[d] = [], s = c = 0, l = (r = null != (p = A.elements) ? p : [A]).length; c < l; s = ++c) o = r[s], f &= (o = null != i[s] ? i[s] : i[s] = new v(o)).done, o.done || (h++, a += o.tick(t));
        ...
        return document.querySelector(".preloader") ? (y.trigger("start"), y.go()) : setTimeout(y.start, 50)
